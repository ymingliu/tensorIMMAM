...
immam4.dr <- 
  function(Y,X,group,K_index=NULL,r1_index=NULL,r2_index=NULL,r3_index=NULL,r4_index=NULL,method="BIC",ncv=10,penalty="LASSO",
    ...
    if(method=="BIC") fit_dr = immam4.bic(Y,X,group,K_index,r1_index,r2_index,r3_index,r4_index,lambda,D0,intercept,opts,opts_pen)
    if(method=="CV") fit_dr = immam4.cv(Y,X,group,ncv,K_index,r1_index,r2_index,r3_index,r4_index,lambda,D0,intercept,opts,opts_pen)
