...
//***------------------------------------------------------------------------------------**
//***-----------------------------Estimation without penalty-----------------------------**
List Estimation_pen_Dj(MatrixXd Y, MatrixXd Z, MatrixXd S, MatrixXd A, MatrixXd B, MatrixXd C, VectorXi &convergence1, int k, double &likhd1, double lambda1, MatrixXd Zm, MatrixXd Am, VectorXi &breakid)
{
    int j, p = A.rows(), K = opts.K;
